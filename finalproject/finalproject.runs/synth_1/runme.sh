...
HD_PWD='C:/Users/User_1/finalproject/finalproject.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log trafficcontrol.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source trafficcontrol.tcl
